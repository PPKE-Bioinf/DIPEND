...
// neighbour is all
    ...
    ofstream out ("/home/zita/Scripts-Research/DIPEND/Data/"+dataset+"-"+neighbourtype+"/"+aa_names[amino_acid]+"/"+neighbourtype+"all.bin", ios::out |   ios::binary);
    if(!out) {
